...
void yjsReadUpdate(
  ...
  transact(
    ...
    (transaction) {
      ...
      // Capture retry update — do NOT call applyUpdateV2 inside transact!
      // Calling it here reuses the same transaction and breaks merge ordering.
      if (retry) {
  ...
  // Retry OUTSIDE the transaction so it gets its own fresh transaction
