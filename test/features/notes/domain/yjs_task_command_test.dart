  ...
  group('YjsDocEditorBridge - task commands', () {
    test(
      ...
      () async {
        ...
        final result = bridge.completeTaskInYDoc(
          'task-1',
        ...
        bridge.reopenTaskInYDoc('task-1', scheduledAt: result.scheduledAt);

        expect(completionsRoot.get(key), isNull);
        expect(readTaskField(doc, 'task-1', 'dueDate'), '2026-07-18');
      },
    );
  });
}
